...
<table>
  ...
  <tbody>
    <tr>
      <td>infracost/infracost-azure-devops/examples/slack/code/plan.json</td>
      <td align="right">$0</td>
...
```
Project: infracost/infracost-azure-devops/examples/slack/code/plan.json
...
Monthly cost change for infracost/infracost-azure-devops/examples/slack/code/plan.json
Amount:  +$743 ($0.00 → $743)
