...
Monthly cost change for infracost/infracost-azure-devops/examples/multi-project-config-file/code/dev
...
Monthly cost change for infracost/infracost-azure-devops/examples/multi-project-config-file/code/prod
